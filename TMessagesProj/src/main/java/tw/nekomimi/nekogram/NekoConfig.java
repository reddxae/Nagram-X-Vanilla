...
public class NekoConfig {
    ...
    public static ConfigItem attachmentTabsTitleType = addConfig("AttachmentTabTitleType", configTypeInt, NekoXConfig.TITLE_TYPE_TEXT);
    ...
    public static ConfigItem disableBlurInMediaPicker = addConfig("DisableBlurInMediaPicker", configTypeBool, false);
